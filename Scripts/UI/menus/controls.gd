...
const CONTROLLER_CONTROLS: Dictionary = {
	"PSen": "res://UI/Menus/Controller/PS5En.png",
	"PSde": "res://UI/Menus/Controller/PS5De.png",
	"XBoxen": "res://UI/Menus/Controller/XBoxEn.png",
	"XBoxde": "res://UI/Menus/Controller/XBoxDe.png"
}
...
func update_controller_controls() -> void:
	...
	controller_image.texture = CONTROLLER_CONTROLS[controller_type + current_lang]
